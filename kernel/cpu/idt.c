...
void idt_setup_exception_handlers() {
  ...
  idt_gen_entry(&global_idt[1], (u32)_isr1, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[2], (u32)_isr2, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[3], (u32)_isr3, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[4], (u32)_isr4, KSEG, IDT_INTERRUPT_GATE_ATTR);
  ...
  idt_gen_entry(&global_idt[0x23], (u32)_irq3, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[0x24], (u32)_irq4, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[0x25], (u32)_irq5, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[0x26], (u32)_irq6, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[0x27], (u32)_irq7, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[0x28], (u32)_irq8, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[0x29], (u32)_irq9, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[0x2a], (u32)_irq10, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[0x2b], (u32)_irq11, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[0x2c], (u32)_irq12, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[0x2d], (u32)_irq13, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[0x2e], (u32)_irq14, KSEG, IDT_INTERRUPT_GATE_ATTR);
  idt_gen_entry(&global_idt[0x2f], (u32)_irq15, KSEG, IDT_INTERRUPT_GATE_ATTR);
