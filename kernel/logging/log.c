...
void kdebug_log(const char *message, ...) {
  ...
  switch (last_msg_prio * (last_msg_prio >= min_loglevel)) {
    case PRIO_DEBUG : {
      kprintf_c("\033[38;5;8m[kernel] debug: ");
    ...
    case PRIO_INFO : {
      kprintf_c("\033[38;5;12m[kernel] info: ");
      kvprintf_c((char *)message, ap);
      kprintf_c(END_LOG);
      break;
    }
    ...
    case PRIO_NOTICE : {
      kprintf_c("\033[38;5;6m[kernel] notice: ");
      kvprintf_c((char *)message, ap);
      kprintf_c(END_LOG);
      break;
    }
    ...
    case PRIO_WARN : {
      kprintf_c("\033[1;33m[kernel] warning: ");
      kvprintf_c((char *)message, ap);
      kprintf_c(END_LOG);
      break;
    }
    ...
    case PRIO_ERROR : {
      kprintf_c("\033[38;5;9m[kernel] error: ");
      kvprintf_c((char *)message, ap);
      kprintf_c(END_LOG);
      break;
    }
    ...
    case PRIO_CRIT : {
      kprintf_c("\033[38;5;1m[kernel] critical: ");
      kvprintf_c((char *)message, ap);
      kprintf_c(END_LOG);
      break;
    }
    ...
    case PRIO_EMERG : {
      kprintf_c("\033[38;5;1m[kernel] emergency: ");
      kvprintf_c((char *)message, ap);
      kprintf_c(END_LOG);
      break;
    }
    ...
    case PRIO_SPANIC : {
      kprintf_c("\033[38;5;15m\033[48;5;1m[kernel] panic: ");
      kvprintf_c((char *)message, ap);
      kprintf_c(END_LOG);
      while (true)
        asm volatile ("hlt");
